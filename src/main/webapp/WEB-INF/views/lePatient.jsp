	...
	<br>
		...
		<table class="table table-striped">
			<tr>
				...
				<tr>
					<td>${lepatient.idPatient}</td>
					<td>${lepatient.nomPatient}</td>
					<td>${lepatient.prenomPatient}</td>
					<td>$lepatient.sexe}</td>
					<td>${lepatient.dateNaissance}</td>
					<td>${lepatient.numSecu}</td>
					<td>${lepatient.mailPatient}</td>
				</tr>
